...
<template>
  <svg
    ...
    xml:space="preserve"
  >
    <circle id="sun" class="ship1" cx="520.8" cy="369.8" r="44.9"></circle>
    <rect id="smoke1" x="173" y="225" width="18" height="10"></rect>
    <rect id="smoke2" x="173" y="225" width="18" height="10"></rect>
    <rect id="smoke3" x="173" y="225" width="18" height="10"></rect>
    <rect id="smoke4" x="173" y="225" width="18" height="10"></rect>
    <g id="ship">
      <polyline
        class="ship3"
    ...
    C262.1,240.9,269.6,239.9,274.8,244z"
      ...
      <polyline
        class="ship1"
        points="269.6,274.3 272.1,274.3 270.9,268.1"
      ></polyline>
      <polygon
        class="ship3"
    ...
    C189.9,281,189.3,281.6,188.6,281.6z"
      ...
      ></path>
      <g id="windows">
        <rect x="299.9" y="278.2" class="ship7" width="2.2" height="3"></rect>
        <rect x="311.9" y="291.2" class="ship7" width="2.2" height="3"></rect>
        <rect x="330.9" y="303.2" class="ship7" width="2.2" height="3"></rect>
        <rect x="308.8" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="281.6" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="256.6" y="291.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="252.1" y="291.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="266.7" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="232.5" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="192.4" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="186.7" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="181.1" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="175.5" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="157.1" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="151.4" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="123.1" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="117.4" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="111.7" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="106.1" y="303.2" class="ship7" width="2.5" height="3"></rect>
        <rect x="275.8" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="270.1" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="264.4" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="239.8" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="234.1" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="228.4" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="223.9" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="218.2" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="212.6" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="206.8" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="201.1" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="168.8" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="163.1" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="157.4" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="152.9" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="147.2" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="141.6" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="135.8" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="130.1" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="124.4" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="119.9" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="114.2" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <rect x="108.6" y="315.8" class="ship7" width="2.5" height="3"></rect>
        <path
          class="ship7"
      ...
      ></path>
      <rect x="238.9" y="228.7" class="ship1" width="2" height="46.2"></rect>
      <line class="ship10" x1="239.9" y1="228.7" x2="221.5" y2="274.5"></line>
      <line class="ship10" x1="240.5" y1="228.7" x2="258.9" y2="274.5"></line>
      <polygon
        class="ship3"
    ...
    <rect id="sea" x="0" y="370" class="ship2" width="600" height="230"></rect>
    <path id="wave6" d="M324.3,382.1c0,0-23.2,2.1-56.7-3"></path>
    <path id="wave5" d="M378.1,378.6c0,0-13.8,3.4-34.5,3.5"></path>
    <path id="wave4" d="M127,375.2c0,0-21.7,5.4-54.4,5.5"></path>
    <path id="wave3" d="M93.1,390.5c0,0-25.7,2.3-62.9-3.4"></path>
    <path id="wave2" d="M200,381c0,0-25.7,2.3-62.9-3.4"></path>
    <path id="wave1" d="M253.6,375.5c0,0-21.8,3.6-42.4,5.3"></path>
    <path
      id="spindript"
      class="ship1"
  ...
  c-5.4-1.8-6.3-5.4-14.5-4.5c-8.1,0.9-6.3,3.6-19,5.4c-12.7,1.8-16.3-3.6-19.9-4.5S296.8,368.3,256.9,371z"
    ></path>
    <g>
      <path id="wave1" d="M538.2,424.7c0,0-21.6,0.7-41.8-0.4"></path>
      <path id="wave2" d="M559.7,388.6c0,0-32.6,2.3-79.8-3.4"></path>
      <path id="wave3" d="M545.5,411c0,0-21.7,5.4-54.4,5.5"></path>
      <path id="wave4" d="M545.9,403.9c0,0-20.5,2.3-50.4-1.5"></path>
      <path id="wave5" d="M553.3,375.1c0,0-29,4.2-72.1,2.2"></path>
    </g>
  </svg>
</template>
